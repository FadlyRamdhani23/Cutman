                            ...
                            <div class="card-body">
                                <form action="{{ route('userStore') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input id="fullName" class="form-control" type="text" name="fullName" :value="old('fullName')" required autofocus />
                                    @error('fullName')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input id="form-control"  class="form-control" type="number" name="phoneNumber" :value="old('phoneNumber')" required  />
                                    @error('phoneNumber')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
