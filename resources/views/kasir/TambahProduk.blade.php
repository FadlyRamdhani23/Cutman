                            ...
                            <div class="card-body">
                                <form action="{{ route('ProdukStore') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="namaProduct" name="namaProduct" placeholder="Masukkan Nama Product" class="form-control">
                                    </div>
                                    <div class="mb-3">
                                        <label for="linkProduct" class="form-label">Link Product</label>
                                        <input type="text" class="form-control" id="linkProduct" name="linkProduct" placeholder="Masukkan Link Product" class="form-control">
                                    </div>
                                    <div class="mb-3">
                                        <label for="fotoProduct" class="form-label">Foto</label>
                                        <input type="file" class="form-control" id="fotoProduct" name="fotoProduct" placeholder="Masukkan Foto Product" class="form-control">
                                    </div>
