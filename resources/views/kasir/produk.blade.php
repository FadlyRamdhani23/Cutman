...
<div class="container-fluid">
    <div class="row">
        <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
            ...
            <div class="position-sticky pt-3">
                ...
                <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="" style="color:#4DAD6B">
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            ...
            <p align="left">    
            <a href="/productTambah"><button class="btn btn-success" href="/productTambah">Tambah Data</button></a>
</p>
...
<script type="text/javascript">
    $(function () {
      ...
      var table = $('#data-table').DataTable({
          processing: true,
          serverSide: true,
          ajax: "{{ route('tampilProduct') }}",
          columns: [
              {data: 'DT_RowIndex', name: 'DT_RowIndex'},
              {data: 'namaProduct', name: 'namaProduct'},
              {data: 'linkProduct', name: 'linkProduct'},
              {data: 'fotoProduct', name: 'fotoProduct'},
