        ...
        <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
            ...
            <div class="position-sticky pt-3">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="/produk" style="color:#4DAD6B">
            ...
            <div class="container">
                <div class="row justify-content-left">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-body">
                                <form action="{{ route('produkUpdate',$product->id) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="mb-3">
                                        <label for="namaProduct" class="form-label">Nama Produk</label>
                                        <input type="text" class="form-control" id="namaProduct" name="namaProduct" placeholder="Masukkan Nama Potongan Rambut" class="form-control" value="{{$product->namaProduct}}">
                                    </div>
                                    <div class="mb-3">
                                        <label for="linkProduct" class="form-label">Link Product</label>
                                        <input type="text" class="form-control" id="linkProduct" name="linkProduct" placeholder="Masukkan Nama Potongan Rambut" class="form-control" value="{{$product->linkProduct}}">
                                    </div>
                                    <div class="mb-3">
                                        <label for="fotoProduct" class="form-label">Foto</label>
                                        <input type="file" class="form-control" id="fotoProduct" name="fotoProduct" placeholder="Masukkan Harga" class="form-control" value="{{$product->fotoProduct}}">
                                    </div>
