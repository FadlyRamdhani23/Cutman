            ...
            <div class="container">
                <div class="row justify-content-left">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-body">
                                <form action="{{ route('rambutUpdate',$rambut->id) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="mb-3">
                                        <label for="namaModel" class="form-label">Nama Potongan Rambut</label>
                                        <input type="text" class="form-control" id="namaModel" name="namaModel" class="form-control" value='{{$rambut->namaModel}}'>
                                    </div>
                                    @error('namaModel')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="file" class="form-control" id="fotoModel" name="fotoModel" class="form-control" value="{{$rambut->namaModel}}">
                                        @error('fotoModel')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
