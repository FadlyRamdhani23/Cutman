        ...
        <div class="container">
                <div class="row justify-content-left">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-body">
                                <form action="{{ route('barberUpdate',$barber->id) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="mb-3">
                                        <label for="namaBarber" class="form-label">Nama Barber</label>
                                        <input type="text" class="form-control" id="namaBarber" name="namaBarber" placeholder="Masukkan Nama Potongan Rambut" class="form-control" value="{{$barber->namaBarber}}">
                                    </div>
                                    <div class="mb-3">
                                        <label for="fotoBarber" class="form-label">Foto</label>
                                        <input type="file" class="form-control" id="fotoBarber" name="fotoBarber" class="form-control" value="/fotobarber/{{$barber->fotoBarber}}">
                                    </div>
                                    <div class="mb-3">
                                        <label for="descBarber" class="form-label">Deskripsi Barber</label>
                                        <input type="textarea" class="form-control" id="descBarber" name="descBarber" placeholder="Masukkan Deskripsi Barber" class="form-control" value="{{$barber->descBarber}}">
                                    </div>
                                    <div class="mb-3">
                                        <label for="twitterBarber" class="form-label">Twitter Barber (optional)</label>
                                        <input type="text" class="form-control" id="twitterBarber" name="twitterBarber" placeholder="Masukkan Twitter Barber" class="form-control" value="{{$barber->twitterBarber}}">
                                    </div>
                                    <div class="mb-3">
                                        <label for="facebookBarber" class="form-label">Facebook Barber (optional)</label>
                                        <input type="text" class="form-control" id="facebookBarber" name="facebookBarber" placeholder="Masukkan Facebook Barber" class="form-control" value="{{$barber->facebookBarber}}">
                                    </div>
                                    <div class="mb-3">
                                        <label for="instagramBarber" class="form-label">Instagram Barber (optional)</label>
                                        <input type="text" class="form-control" id="instagramBarber" name="instagramBarber" placeholder="Masukkan Instagram Barber" class="form-control" value="{{$barber->instagramBarber}}">
                                    </div>
                                    <div class="mb-3">
                                        <label for="linkedinBarber" class="form-label">Linkedin Barber (optional)</label>
                                        <input type="text" class="form-control" id="linkedinBarber" name="linkedinBarber" placeholder="Masukkan Linkedin Barber" class="form-control" value="{{$barber->linkedinBarber}}">
                                    </div>
