                            ...
                            <div class="card-body">
                                <form action="{{ route('produkStore') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="namaProduct" name="namaProduct" placeholder="Masukkan Nama Produk" class="form-control">
                                    @error('namaProduct')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="linkProduct" name="linkProduct" placeholder="Masukkan Link Produk" class="form-control">
                                    @error('linkProduct')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <input type="file" class="form-control" id="fotoProduct" name="fotoProduct" class="form-control">
                                    @error('fotoProduct')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                    </div>
