...
<div class="container-fluid">
    <div class="row">
        ...
        <h1 class="h2">Update Potongan Rambut</h1>
        </div>
            <div class="container">
                            ...
                            <div class="card-body">
                                <form action="{{ route('produkUpdate',$product->id) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="namaModel" name="namaModel" class="form-control" value="{{$product->namaProduct}}">
                                    </div>
                                    @error('namaModel')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    <div class="mb-3">
                                        <label for="linkProduct" class="form-label">Nama Potongan Rambut</label>
                                        <input type="text" class="form-control" id="linkProduct" name="linkProduct" class="form-control" value="{{$product->linkProduct}}">
                                    </div>
                                    <div class="mb-3">
                                        <label for="fotoProduct" class="form-label">Foto</label>
                                        <input type="file" class="form-control" id="fotoProduct" name="fotoProduct" class="form-control" value="{{$product->fotoProduct}}">
                                    </div>
