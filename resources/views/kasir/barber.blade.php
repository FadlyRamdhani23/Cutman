...
<div class="container-fluid">
    <div class="row">
        <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
            ...
            <div class="position-sticky pt-3">
                ...
                <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#" style="color:#4DAD6B">
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                <h1 class="h2">Data Barber</h1>

            </div>
            <a href="/barberTambah"><button class="btn btn-success" href="/barberTambah"> Tambah Data</button></a>
    ...
    $(document).ready(function () {
        $('#datatable').DataTable({
            ...
            columns: [
                ...
                {data: 'namaBarber', name: 'namaBarber'},
                {data: 'fotoBarber', name: 'fotoBarber'},
                {data: 'descBarber', name: 'descBarber'},
                {data: 'twitterBarber', name: 'twitterBarber'},
                {data: 'facebookBarber', name: 'facebookBarber'},
                {data: 'instagramBarber', name: 'instagramBarber'},
                {data: 'linkedinBarber', name: 'linkedinBarber'},
