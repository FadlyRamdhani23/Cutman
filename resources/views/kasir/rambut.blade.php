...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                <h1 class="h2">Data Potongan Rambut</h1>

            </div>
            <p align="left">    
            <a href="/rambutTambah"><button class="btn btn-success" href="/rambutTambah"> Tambah Data</button></a>
</p>
